...
/**
 *  Font   font   =   null;   
 *  font   =   MyFontChooser1.showDialog(this,null,font);  
 */

public class MyFontChooser extends JDialog {
	
	private static final long serialVersionUID = 1157421L;
	...
	private MyFontChooser(Frame parent, boolean modal, Font font) {
		super(parent, modal);
		initAll();
	...
	public static Font showDialog(Frame parent, String s, Font font) {
		MyFontChooser fd = new MyFontChooser(parent, true, font);
		if (s != null)
			fd.setTitle(s);
		fd.setVisible(true);
		Font fo = null;
	...
	public class NwList extends JPanel {
		...
		private static final long serialVersionUID = 1287275L;
		JList jl;
		JScrollPane sp;
		JLabel jt;
		String si = "   ";
