...
<tr>
 ...
 <td><input type="text" maxlength="16" name="username" id="username" class="m_tb" style="width:180px" onblur="check_repeat(this.value,'username')"> <span id="s_username">由中英字符、数字、下划线组成(4-16位)</span></td>
</tr

<tr>
 <td class="tdhead">密 码<span style="color:#ff0000">*</span></td>
 <td><input type="password"  maxlength="16" name="password" id="password" class="m_tb" style="width:180px"> 由字母、数字、下划线组成(4-16位) </td>
</tr>
...
<tr><td colspan="2" align="center"><input id="bt_post" type="button"  value=" 提示：请先填写以上注册资料！ " onclick="return Check_Reg('<%=security_code%>')" disabled><td></tr>
