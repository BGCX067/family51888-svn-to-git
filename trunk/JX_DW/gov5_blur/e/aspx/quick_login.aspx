...
private void Login_Check()
 {
   ...
   sql="select id,checked,m_type from pa_member where username='"+UserName+"' and userpassword='"+Password+"'";
...
private void  Build_Cookie()
 {
     ...
     Update_Member(UID,LoginDate);
     Session["YZM"]="";
 }

private void Update_Member(string Uid,DateTime LoginDate)
 {
   string Lst_Ip=GetClientIP();
   sql="update pa_member set lastdate='"+LoginDate+"',lst_ip='"+Lst_Ip+"',logins=logins+1 where id="+Uid;
   OleDbCommand Comm=new  OleDbCommand(sql,conn);
   Comm.ExecuteNonQuery();
 }
