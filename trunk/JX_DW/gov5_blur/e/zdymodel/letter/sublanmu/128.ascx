...
<form action="/e/aspx/post.aspx" method="post" enctype="multipart/form-data" name="letter">
    ...
    <ul>
        ...
        <li style="clear: both;font-size: 1px; line-height:0px; height:2px">&nbsp;</li>
        <li style="clear: both;padding:5px 0 5px 95px">
<input type="hidden" name="sort" value="<%=Sort_Id%>" />
&nbsp;<input class="button" type="submit" onclick="return set_letter()" value=" 提交 " /> <input class="button" type="reset" value=" 重设 " /></li>
    </ul>
    </div>
    <input type="hidden" name="checkyzm" value="1" /> <input type="hidden" name="checked" value="0" /> <input type="hidden" name="to" /> <input type="hidden" name="mailto" /> <input type="hidden" name="mailreply" /> <input type="hidden" name="mailsubject" /> <input type="hidden" name="mailbody" /> <input type="hidden" name="sendmail" value="0" /> <input type="hidden" name="insertdatabase" value="1" /> <input type="hidden" name="siteid" value="1" /> <input type="hidden" name="formtable" value="letter" />
</form>
...
{
dt1=Get_Reply("letter",int.Parse(dr["id"].ToString()));  
