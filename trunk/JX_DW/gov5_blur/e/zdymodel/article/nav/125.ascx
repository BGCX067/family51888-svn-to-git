...
<%if(Zdy_Tag==0){%><div id="nav_<%=Nav_Id%>" <%=Nav_box_style%> class="nav_box nav_box_<%=Query_Table%>">
...
<%}%><%conn.Open();%><ul class="article" id="n_<%=Nav_Id%>" style="overflow:hidden;height:220px;"><% 
