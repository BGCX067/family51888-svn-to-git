...
<tr>
 ...
 <table border=0 cellpadding=2 cellspacing=0 width=95% align=center>
   <tr>
    ...
    <select Name="Fields" id="Fields" size="9" onclick="Get_FieldUse(this.options[this.selectedIndex].value)">
    </select>
   </td>
    <td align=left>
 ...
 以上遵行asp.net语法，可在现有基础上自行扩展。
   ...
   <div name="tabcontent" id="tabcontent">
    <table border=0 cellpadding=0 cellspacing=5 width=95% align=center>
     ...
     <td><TextArea name="model_content" style="width:760px;height:400px"><%=Model_Content%></TextArea></td>
     </tr>
    </table>
   </div>
