...
<tr>
 ...
 <table border=0 cellpadding="0px" cellspacing="1px" width=95% align=center>
      ...
      <tr>
        <td align="left" width="10%" height="25px">用户名：</td><td lign="left"><asp:TextBox Id="UserName" runat="server" Cssclass="member_info_textbox" Enabled="false" style="width:120px" />&nbsp;<input type="button" value="会员中心" class="bt" onclick="Go_Member()"/><a href="gotomember.aspx?username=<%=User_Name%>" id="gotomember" target="_blank"></a>&nbsp;<input type="button" value="发信" class="bt" onclick="SendMsg('<%=User_Name%>')"></td>
