             ...
             <ItemTemplate>
                <tr class="listitem">
                  ...
                  <td align=center class=tdstyle>
                   ...
                   <a href="javascript:style_set('lanmu_style_set.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id")%>&type=<%=Thetype%>&name=<%#Server.UrlEncode(DataBinder.Eval(Container.DataItem,"name").ToString())%>')">设置</a>
