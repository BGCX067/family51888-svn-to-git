          ...
          <asp:Repeater id="dtl1" runat="server"  OnItemDataBound="Data_Bound">  
             <ItemTemplate>
               <tr class="listitem">
                  ...
                  <td height=25 align=center class=tdstyle><%#Get_PayState(DataBinder.Eval(Container.DataItem,"paystate").ToString())%></td></td>
                  <td height=25 align=center class=tdstyle><%#Get_SendState(DataBinder.Eval(Container.DataItem,"sendstate").ToString())%></td></td>
