...
<asp:Repeater id="DL_1" runat="server" OnItemDataBound="Data_Bound">
   <ItemTemplate>  
        <tr bgcolor="#ffffff">
         <td class=tdstyle><a href="<%#Get_DetailUrl(DataBinder.Eval(Container.DataItem,"thetable").ToString(),DataBinder.Eval(Container.DataItem,"detail_id").ToString())%>" target=_blank><%#DataBinder.Eval(Container.DataItem,"title")%></a></td>
         <td align=center class=tdstyle><asp:Label Id="Pdnumber" Text='<%#DataBinder.Eval(Container.DataItem,"num")%>' runat="server"  /></td>
...
<asp:ListItem value="-1">缺货</asp:ListItem>
      ...
      <tr>
         <td height=30 class=tdstyle colspan="6">产品总价：<span  style="color:#ff0000">￥<asp:Label Id="ProdTongji" runat="server"/></span> &nbsp;&nbsp; 赠送总积分为：<span  style="color:#ff0000"><%=AllPoint%></span></td>
       </tr>
      <tr>
         <td height=30 class=tdstyle colspan="6">配送费用：￥<asp:TextBox Id="SendExpense" runat="server" size="5" /> &nbsp;配送方式：<asp:TextBox Id="Tb_SendWay" runat="server" size="25" Maxlength="50" /></td>
       </tr>
      <tr>
         <td height=30 class=tdstyle colspan="6">总费用：<span  style="color:#ff0000">￥<asp:Label Id="LblTongji" runat="server"/></span></td>
       </tr>
</table>
<br>
