...
private void Data_Bind()
 {
   ...
   string sql="select id,title,thetable,detail_id,num,state,member_price,(num*member_price) as tongji from pa_orderlist where order_id='"+Str_orderid+"'";
  ...
  switch(Str)
   {
    ...
    case "1":
     return "<font color=#ff0000>已发货</font>";
    break;

    case "-1":
     return "<font color=#0066FF>待处理</font>";
    break;
