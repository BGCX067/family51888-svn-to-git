...
<span id="c_name_sign">用户：</span><input type="textbox" id="c_username"  maxlength="10" size="12" class="tb">
<span id="c_yzm_sign">验证码：</span><input type='textbox' id="c_yzm" size="5" maxlength='4' class="tb">&nbsp;<img src='/e/aspx/yzm.aspx' onclick="Code_Change('yzmcode')" align=absmiddle border=0 id="yzmcode" style='cursor:pointer;height:20px'>
</span><%}%>
<span id="c_member_box" style="display:none">
<span id="c_username_sign">用户名：</span><input type="textbox" id="username" maxlength="16" size="12" class="tb">&nbsp;<span id="c_pass_sign">密码：</span><input type="password" id="password" maxlength="20" size="12" class="tb">
</span>
<%if(Comment_Anonymous=="1"){%>
<input type="checkbox" id="anonymous" value="1" checked onclick="c_type(this.checked)"><span id="c_anonymous_sign">匿名</span>&nbsp;<%}%>
