	...
	<body>
		<div id="doc3">
			...
			<div id="bd">
				<div id="yui-main">
					<div class="yui-b">
<form action="${ctx}/gradeAction.do?method=updateGrade" method="post">
		<table table width="100%" align="center" cellspacing="0" cellpadding="0"
			...
			<td>UUID</td>
			<td>
			<input name="uuid" type="text" value="${model.uuid }" readonly>
			</td>
			</tr>
			<tr>
			<td>学号</td>
			...
			<input type="button" value="修改" onclick="gotoSubmit()"><input type="button" value="返回" onclick="gotoCancel()">
		</form>
		</div>
				</div>
			</div>
	...
	function gotoSubmit(){
			document.forms[0].action="gradeAction.do?method=updateGrade";
	   		document.forms[0].submit();
	}
	</script>
</html>
