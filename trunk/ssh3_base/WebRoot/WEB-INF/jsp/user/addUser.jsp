	...
	<body>
		<div id="doc3">
			...
			<div id="bd">
				<div id="yui-main">
					<div class="yui-b">
						<form id="inputForm" action="userAction.do?method=addUser" method="post">
							<table class="noborder">
								...
								<tr>
									...
									<td>
										<input name="descn" type="text" value="${model.descn }">
									</td>
								</tr>
								<tr>
								</tr>
							...
							<input type="button" value="返回" onclick="gotoCancel()">
						</form>
					</div>
				</div>
			</div>
