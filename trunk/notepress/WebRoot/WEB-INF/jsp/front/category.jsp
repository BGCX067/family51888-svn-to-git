...
<head>
<title>${category.categoryName}-AJava.org</title>
...
<div class="container">
	...
	<div class="span-19 last">
		<h5 class="content-color round-box">${category.categoryName}故事列表</h5>
		<c:forEach items="${storyList}" var="story" begin="0" step="1"
			varStatus="index">
