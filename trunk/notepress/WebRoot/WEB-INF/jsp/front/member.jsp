...
<div class="container">
		...
		<div class="span-5 last">
			<div><span class="border">欢迎你--${account.accountAlias}</span><span class="border"><a href="${pageContext.request.contextPath}/logout">退出</a></span></div>
...
<div class="container">
	...
	<div class="span-19 last">
		<!-- 最新文件 -->
		<h5 class="content-color round-box">欢迎${account.accountAlias}进入会员中心！</h5>
		<div class="round-box last" id="comment">
		本系统还在不断完善中，还存在不少问题，请各位谅解。
		</div>
		<!-- 最新文件 -->
	</div>
	<!-- 右部 -->
